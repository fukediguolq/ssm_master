...
public class AdminHandler {
	...
	public String register(String name,String username,String password, @RequestParam("touxiang") MultipartFile filetx) throws IllegalStateException, IOException {
		...
		Admin admin=new Admin(null, name, username, password, touxiang);
